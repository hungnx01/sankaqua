(function ($) {
    ...
    function singleProductGalleryImages() {
        ...
        if (galleryHorizontal.length > 0) {
            ...
            $('<div class="swiper-button-next swiper-button hnice-icon-right-arrow"></div><div class="swiper-button-prev swiper-button hnice-icon-left-arrow"></div>').insertAfter(galleryHorizontal);
