...
global $product;
$product_sku = ($sku = $product->get_sku()) ? $sku : esc_html__('N/A', 'hnice');
?>
<div class="product_meta">
    ...
    <?php if (wc_product_sku_enabled() && ($product->get_sku() || $product->is_type('variable'))) : ?>
        ...
        <span class="sku_wrapper"><span class="meta-label"><?php esc_html_e('SKU:', 'hnice'); ?> </span><span class="sku"><?php echo sprintf('%s', $product_sku); ?></span></span>
