...
class Hnice_Call_To_Action extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Hnice Banner', 'hnice');
    }
    ...
    protected function register_controls( $args = [] ) {
        ...
        $default_args = [
            'section_condition' => [],
            'button_default_text' => esc_html__( 'Click here', 'hnice' ),
            'text_control_label' => esc_html__( 'Text', 'hnice' ),
        ...
        $this->add_control(
            'bg_image',
            [
                'label'   => esc_html__('Choose Background Image', 'hnice'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => esc_html__('Image Resolution', 'hnice'),
                'default'   => 'large',
                'condition' => [
                    'bg_image[id]!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => esc_html__('This is the sub title', 'hnice'),
                'placeholder' => esc_html__('Enter your sub title', 'hnice'),
                'label_block' => true,
                'separator'   => 'before',
            ]
        );
        ...
        $this->add_control(
            'sub_title_position',
            [
                'label'        => __('Position Sub Title', 'hnice'),
        ...
        $this->add_control(
            'title',
            [
                'label'       => esc_html__('Heading 1', 'hnice'),
                'type'        => Controls_Manager::TEXT,
                'dynamic'     => [
                    'active' => true,
                ],
                'default'     => esc_html__('This is the heading 1', 'hnice'),
                'placeholder' => esc_html__('Enter your heading 1', 'hnice'),
                'label_block' => true,
                'separator'   => 'before',
            ]
        );
        ...
        $this->add_control(
            'heading2',
            [
                'label'       => esc_html__('Heading 2', 'hnice'),
                'type'        => Controls_Manager::TEXT,
                'dynamic'     => [
                    'active' => true,
                ],
                'default'     => esc_html__('This is the heading 2', 'hnice'),
                'placeholder' => esc_html__('Enter your heading 2', 'hnice'),
                'label_block' => true,
                'separator'   => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => esc_html__('Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'hnice'),
                'placeholder' => esc_html__('Enter your description', 'hnice'),
                'separator'   => 'none',
                'rows'        => 5,
            ]
        );
        ...
        $this->add_control(
            'link_click',
            [
                'label'     => esc_html__('Apply Link On', 'hnice'),
                'type'      => Controls_Manager::SELECT,
                'options'   => [
                    'box'    => esc_html__('Whole Box', 'hnice'),
                    'button' => esc_html__('Button Only', 'hnice'),
                ],
                'default'   => 'button',
                'separator' => 'none',
                'condition' => [
        ...
        $this->add_control(
            'content-stretch',
            [
                'label'        => esc_html__('Stretch', 'hnice'),
        ...
        $this->add_responsive_control(
            'inner_padding',
            [
                'label'      => esc_html__('Padding Content', 'hnice'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em'],
                'selectors'  => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Background Content', 'hnice'),
        ...
        $this->add_responsive_control(
            'Horizontal_align',
            [
                'label'     => esc_html__('Horizontal Align', 'hnice'),
                'type'      => Controls_Manager::CHOOSE,
                'options'   => [
                    'flex-start' => [
                        'title' => esc_html__('Left', 'hnice'),
        ...
        $this->add_control(
            ...
            [
                ...
                'label'     => esc_html__('Heading', 'hnice'),
                'separator' => 'before',
                'condition' => [
                    'title!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'type'      => Controls_Manager::HEADING,
                'label'     => esc_html__('Subtitle', 'hnice'),
                'separator' => 'before',
                'condition' => [
                    'subtitle!' => '',
                ],
        ...
        $this->add_control(
            'title_color',
            [
                'label'     => esc_html__('Heading Color', 'hnice'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'heading2_color',
            [
                'label'     => esc_html__('Heading2 Color', 'hnice'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'subtitle_color',
            [
                'label'     => esc_html__('Sub title Color', 'hnice'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'description_color',
            [
                'label'     => esc_html__('Description Color', 'hnice'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default'      => 'default',
                'prefix_class' => 'button-banner-style-hnice-',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__('Position Bottom', 'hnice'),
                'type'         => Controls_Manager::SWITCHER,
                'condition'    => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Box Text Color', 'hnice'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'hover_effects',
            [
                'label' => esc_html__('Hover Effects', 'hnice'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'transformation',
            [
                'label'        => esc_html__('Hover Animation', 'hnice'),
                'type'         => Controls_Manager::SELECT,
                'options'      => [
                    ''                  => 'None',
                    'zoom-in'           => 'Zoom In',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'       => '{{WRAPPER}}.elementor-widget-hnice-banner:not(:hover) .elementor-cta__bg-overlay',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}}.elementor-widget-hnice-banner:hover .elementor-cta__bg',
            ]
        );
        ...
        $this->add_control(
            'effect_duration',
            [
                'label'       => esc_html__('Transition Duration', 'hnice'),
                'type'        => Controls_Manager::SLIDER,
...
$widgets_manager->register(new Hnice_Call_To_Action());
