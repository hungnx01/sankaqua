...
class Hnice_Woocommerce_Brand {
    ...
    public function load_media() {
        ...
        wp_enqueue_media();
        wp_enqueue_script('shoppic-admin-woocommerce-brand-scripts', get_theme_file_uri('assets/js/admin/woocommerce-brand.js'), array('jquery'), $hnice_version, true);
    }
    ...
    */
    public function add_product_brand_image($taxonomy) { ?>
        <div class="form-field term-group">
            <label for="product_brand_logo"><?php esc_html_e('Image', 'hnice'); ?></label>
            ...
            <p>
                <input type="button" class="button button-secondary ct_tax_media_button" id="ct_tax_media_button" name="ct_tax_media_button" value="<?php esc_html_e('Add Image', 'hnice'); ?>"/>
                <input type="button" class="button button-secondary ct_tax_media_remove" id="ct_tax_media_remove" name="ct_tax_media_remove" value="<?php esc_html_e('Remove Image', 'hnice'); ?>"/>
            </p>
        </div>
        <?php
    }
