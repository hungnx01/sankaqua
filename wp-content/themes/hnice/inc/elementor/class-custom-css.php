...
class Hnice_Elementor_Custom_Css {
    ...
    public function add_scripts_editor() {
        ...
        wp_enqueue_script( 'hnice-elementor-custom-css', get_theme_file_uri( '/assets/js/elementor-custom-css.js' ), [], $hnice_version, true );
    }
    ...
    public function register_controls( Controls_Stack $element, $section_id ) {
        ...
        $element->start_controls_section(
            'section_custom_css',
            [
                'label' => esc_html__( 'Custom CSS', 'hnice' ),
                'tab' => $old_section['tab'],
            ]
        );
        ...
        $element->add_control(
            'custom_css_title',
            [
                'raw' => esc_html__( 'Add your own custom CSS here', 'hnice' ),
        ...
        $element->add_control(
            ...
            [
                'raw' => wp_kses_post(__( 'Use "selector" to target wrapper element. Examples:<br>selector {color: red;} // For main element<br>selector .child-element {margin: 10px;} // For child element<br>.my-class {text-align: center;} // Or use any custom selector', 'hnice' )),
                'type' => Controls_Manager::RAW_HTML,
...
return new Hnice_Elementor_Custom_Css();
