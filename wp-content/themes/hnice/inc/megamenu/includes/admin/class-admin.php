...
class Hnice_Admin_MegaMenu {
    ...
    public function process_create_related($post_id) {
        if (isset($_GET['hnice-menu-createable']) && isset($_GET['menu_id']) && absint($_GET['menu_id'])) {
            ...
            if ($related_id && isset($_REQUEST['menu_id']) && is_admin()) {
                ...
                $action = add_query_arg(array('hnice-menu-editable' => 1), $url);
