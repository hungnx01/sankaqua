...
class Hnice_Elementor_Sticky_Section {
    ...
    public function scripts() {
        ...
        wp_register_script('elementor-sticky', get_template_directory_uri() . '/assets/js/frontend/jquery.sticky.js', ['jquery'], $hnice_version, true);
        wp_enqueue_script('hnice-elementor-sticky', get_template_directory_uri() . '/assets/js/libs/sticky.js', ['jquery', 'elementor-frontend', 'elementor-sticky'], $hnice_version, true);
    }
    ...
    public function register_controls(Element_Base $element) {
        ...
        foreach ($active_devices as $device) {
            $label                          = 'desktop' === $device ? esc_html__('Desktop', 'hnice') : $active_breakpoint_instances[$device]->get_label();
        ...
        $element->add_control(
            'sticky_on',
            [
                'label'              => esc_html__('Sticky On', 'hnice'),
        ...
        $element->add_responsive_control(
            ...
            [
                'label'              => esc_html__('Effects Offset', 'hnice'),
                'type'               => Controls_Manager::NUMBER,
                'default'            => 0,
                'min'                => 0,
                'max'                => 1000,
        ...
        if ($this->is_instance_of($element, $types)) {
            ...
            $element->add_control(
                'sticky_parent',
                [
                    'label'              => esc_html__('Stay In Column', 'hnice'),
...
new Hnice_Elementor_Sticky_Section();
