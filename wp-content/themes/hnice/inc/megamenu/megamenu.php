...
class Hnice_Megamenu {
    ...
    public function __construct() {
        ...
        add_filter('hnice_nav_menu_args', [$this, 'set_menu_args'], 99999);

    }

    public function set_menu_args($args) {
        $args['walker'] = new Hnice_Megamenu_Walker();
    ...
    private function check_megamenu() {
        ...
        foreach ($all as $menu_item) {
            $elementor_id = hnice_megamenu_get_post_related_menu($menu_item->ID);
            if ($elementor_id) {
    ...
    public function enqueue_scripts() {
        ...
        wp_enqueue_script('hnice-megamenu-frontend', get_template_directory_uri() . '/inc/megamenu/assets/js/frontend.js', array('jquery'), $hnice_version, true);
