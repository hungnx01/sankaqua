 ...
 * @since 1.0.0
 */
class Hnice_Elementor_Widget_Products_Recently extends \Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'hnice-products-recently';
    }
    ...
    public function get_title() {
        return esc_html__('Products Recently', 'hnice');
    }
    ...
    protected function render() {
        ...
        if (empty($viewed_products)) {
            echo '<p class="recently-notice">' . esc_html__('There’s no item that you viewed recently.', 'hnice') . '</p>';
            return;
        }
...
$widgets_manager->register(new Hnice_Elementor_Widget_Products_Recently());
