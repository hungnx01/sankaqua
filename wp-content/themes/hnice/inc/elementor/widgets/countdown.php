...
class Hnice_Elementor_Countdown extends Elementor\Widget_Base {

    public function get_name() {
        return 'hnice-countdown';
    }

    public function get_title() {
        return esc_html__('Hnice Countdown', 'hnice');
    }
    ...
    public function get_script_depends() {
        return ['hnice-elementor-countdown'];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_countdown',
            [
                'label' => esc_html__('Countdown', 'hnice'),
            ]
        );
        ...
        $this->add_control(
            'due_date',
            [
                'label'       => esc_html__('Due Date', 'hnice'),
                'type'        => Controls_Manager::DATE_TIME,
                'default'     => date('Y-m-d H:i', strtotime('+1 month') + (get_option('gmt_offset') * HOUR_IN_SECONDS)),
                /* translators: %s: Time zone. */
                'description' => sprintf(esc_html__('Date set according to your timezone: %s.', 'hnice'), Utils::get_timezone_string()),
            ]
        );
        ...
        $this->add_control(
            'show_minutes',
            [
                'label'     => esc_html__('Minutes', 'hnice'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'hnice'),
                'label_off' => esc_html__('Hide', 'hnice'),
                'default'   => 'yes',
        ...
        $this->add_control(
            'show_seconds',
            [
                'label'     => esc_html__('Seconds', 'hnice'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'hnice'),
                'label_off' => esc_html__('Hide', 'hnice'),
                'default'   => 'yes',
        ...
        $this->add_control(
            'show_labels',
            [
                'label'     => esc_html__('Show Label', 'hnice'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'hnice'),
                'label_off' => esc_html__('Hide', 'hnice'),
                'default'   => 'yes',
        ...
        $this->add_control(
            'custom_labels',
            [
                'label'     => esc_html__('Custom Label', 'hnice'),
                'type'      => Controls_Manager::SWITCHER,
                'condition' => [
                    'show_labels!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Days', 'hnice'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Days', 'hnice'),
                'placeholder' => esc_html__('Days', 'hnice'),
                'condition'   => [
                    'show_labels!'   => '',
                    'custom_labels!' => '',
                    'show_days'      => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Hours', 'hnice'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Hours', 'hnice'),
                'placeholder' => esc_html__('Hours', 'hnice'),
                'condition'   => [
                    'show_labels!'   => '',
                    'custom_labels!' => '',
                    'show_hours'     => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Minutes', 'hnice'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Minutes', 'hnice'),
                'placeholder' => esc_html__('Minutes', 'hnice'),
                'condition'   => [
                    'show_labels!'   => '',
                    'custom_labels!' => '',
                    'show_minutes'   => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Seconds', 'hnice'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Seconds', 'hnice'),
                'placeholder' => esc_html__('Seconds', 'hnice'),
                'condition'   => [
                    'show_labels!'   => '',
                    'custom_labels!' => '',
                    'show_seconds'   => 'yes',
        ...
        $this->add_responsive_control(
            'container_width',
            [
                'label'      => esc_html__('Container Width', 'hnice'),
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .elementor-hnice-countdown' => 'max-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'items_width',
            [
                'label'      => esc_html__('Items Width', 'hnice'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'items_height',
            [
                'label'      => esc_html__('Items Height', 'hnice'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}}.elementor-widget-hnice-countdown .elementor-countdown-item:before' => 'right: -{{RIGHT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default'   => 'center',
                'selectors' => [
                    '{{WRAPPER}} .elementor-hnice-countdown' => 'justify-content: {{VALUE}}',
    ...
    private function _init_default_countdown_labels() {
        $this->_default_countdown_labels = [
            'label_months'  => esc_html__('Months', 'hnice'),
            'label_weeks'   => esc_html__('Weeks', 'hnice'),
            'label_days'    => esc_html__('Days', 'hnice'),
            'label_hours'   => esc_html__('Hrs', 'hnice'),
            'label_minutes' => esc_html__('Mins', 'hnice'),
            'label_seconds' => esc_html__('Secs', 'hnice'),
        ];
    }
    ...
    protected function render() {
        ...
        <div class="countdown-inner">
            ...
            <?php endif; ?>
            <div class="elementor-hnice-countdown" data-date="<?php echo esc_attr($due_date); ?>">
                <?php echo hnice_elementor_get_strftime($instance, $this); // WPCS: XSS ok. ?>
            </div>
        </div>
        <?php
    }
...
$widgets_manager->register(new Hnice_Elementor_Countdown());
