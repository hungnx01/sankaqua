...
class Hnice_Elementor_Nav_Menu extends Elementor\Widget_Base {

    protected $nav_menu_index = 1;

    public function get_name() {
        return 'hnice-nav-menu';
    }

    public function get_title() {
        return esc_html__('Hnice Nav Menu', 'hnice');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography Menu', 'hnice'),
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'label'    => esc_html__('Typography Sub Menu', 'hnice'),
        ...
        $this->add_control(
            ...
            [
                ...
                'prefix_class' => 'hnice-nav-menu-divider-',
            ]
        );
        ...
        $this->add_control(
            'menu_title_color',
            [
                'label'     => esc_html__('Color Menu', 'hnice'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Color Sub Menu', 'hnice'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'sub_menu_color',
            [
                'label'     => esc_html__('Background Dropdown', 'hnice'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}}.hnice-nav-menu-divider-yes .main-navigation ul.menu > li.menu-item > a:before' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Background Item', 'hnice'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
    ...
    protected function render() {
        ...
        <div <?php $this->print_render_attribute_string('wrapper'); ?>>
            <nav class="main-navigation" role="navigation" aria-label="<?php esc_attr_e('Primary Navigation', 'hnice'); ?>">
...
$widgets_manager->register(new Hnice_Elementor_Nav_Menu());
