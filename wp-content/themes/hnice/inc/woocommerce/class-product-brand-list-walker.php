<?php
/**
 * Hnice_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        Hnice_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Hnice_Product_Brand_List_Walker', false)) :

	class Hnice_Product_Brand_List_Walker extends Walker {
